...
let storeName = 'titanshops';
let bookstore_id = 2895;
let storeid = 'B00296';
...
async function getBooksDetails(sectionId) {
    let res = '';
    try {
        let str = await fetch(`https://www.${storeName}.com/sca-dev-2020-2-0/extensions/Titanshops/AdoptionSearchTitanshopsExtension/1.0.1/services/AdoptionSearch.Service.ss?c=${code}&ccId=${sectionId}&n=2&searchAdoptions=true`, {
            method: 'GET',
            mode: 'cors',
            headers: headers
        })
...
async function getSection(termId, departmentId, courseId) {
    let res = '';
    try {                    //https://www.titanshops.com/sca-dev-2020-2-0/extensions/Titanshops/AdoptionSearchTitanshopsExtension/1.0.1/services/AdoptionSearch.Service.ss?c=4495191&catalogNmbr=AMST%20201&department=276&isAllowed=true&n=2&school=&searchAdoptionParameters=true&term=245
        let str = await fetch(`https://www.${storeName}.com/sca-dev-2020-2-0/extensions/Titanshops/AdoptionSearchTitanshopsExtension/1.0.1/services/AdoptionSearch.Service.ss?c=${code}&catalogNmbr=${courseId}&department=${departmentId}&isAllowed=true&n=2&school=&searchAdoptionParameters=true&term=${termId}`)
        res = await str.json();
    } catch (error) {
...
async function getCourses(termId, departmentId) {
    let res = '';
    try {
        let str = await fetch(`https://www.${storeName}.com/sca-dev-2020-2-0/extensions/Titanshops/AdoptionSearchTitanshopsExtension/1.0.1/services/AdoptionSearch.Service.ss?c=${code}&catalogNmbr=&department=${departmentId}&isAllowed=true&n=2&school=&searchAdoptionParameters=true&term=${termId}`)
        res = await str.json();
    } catch (error) {
...
async function getDepartments(termId) {
    let res = '';
    try {
        let str = await fetch(`https://www.${storeName}.com/sca-dev-2020-2-0/extensions/Titanshops/AdoptionSearchTitanshopsExtension/1.0.1/services/AdoptionSearch.Service.ss?c=${code}&catalogNmbr=&department=&isAllowed=true&n=2&school=&searchAdoptionParameters=true&term=${termId}`)
        res = await str.json();
    } catch (error) {
...
async function getTerm(storeName) {
    let res = '';
    try {
        let str = await fetch(`https://www.${storeName}.com/sca-dev-2020-2-0/extensions/Titanshops/AdoptionSearchTitanshopsExtension/1.0.1/services/AdoptionSearch.Service.ss?c=${code}&n=2&searchAdoptionParameters=true`)
        res = await str.json();
    } catch (error) {
        console.log("Department API", error)
    }
